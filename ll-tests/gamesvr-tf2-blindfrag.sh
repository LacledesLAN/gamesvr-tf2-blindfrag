#!/bin/bash -i
declare LLCK_LOGFILE="/app/ll-tests/gamesvr-tf2-blindfrag.log";
declare LLCK_CMD="/app/srcds_run -game tf -console +map koth_harvest_final +maplist mapcycle_quickplay_koth -insecure -maxplayers 8 -norestart +sv_lan 1";
